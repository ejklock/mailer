    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3>Templates de Email | Editar Templates</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" role="form" method="POST"
                    action="{{ route('painel.mailtemplate.update', $template->id) }}" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="col-md-12">
                        <div class="input-group mb-4">
                            ...
                            <input type="text" name="name" value="{{ $template->name }}" aria-label="assunto"
                                class="form-control">
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <textarea id="texto" class="my-editor"
